...
# type(fruits.values()) = dict_values, not a list
# if we want to make it a list, we can use list(fruits.values()), then we can transform it to list

for fruit in fruits.values():
    num_fruits.append(fruit)
