...
email_addresses = []
for address in umsi_faculty:
    email_addresses.append(f"{address.split('|')[2]}")
...
for address_length in email_addresses:
    if len(address_length) > 15:
        long_email_addresses.append(f"{address_length}")
