...
element_hello_type = type(elements[0])
...
elements_six_seven_half = elements[3:5]
...
elements_last_three = elements[-3:]
...
word_lengths = []
rhino_str_list = rhino_str.split(' ')
for word in rhino_str_list:
...
def get_counts(file_name, characters):
    ...
    with open(file_name, "r") as file_obj:
        for line in file_obj:
            for char in line: # FIX ME (for char in xyz statement throws NameError. Replace xyz with correct sequence.)
